...
function create_bulk_glass_posts() {
	...
	$titles = [
			'Acoustic', 'Back-Painted', 'Bird-Friendly', 'Ceramic Frit', 'Channel',
			'Digital Printed', 'EcoGlass', 'Etched', 'Lamberts Stained Glass',
			'Laminated', 'Marker Board', 'Mirrored', 'Restoration Glass®',
			'Textured or Patterned (SEO)', 'Cabinet Glass'
	];
...
function create_bulk_application_posts() {
	...
	// Titles for the new posts
	$titles = [
			'Exterior', 'Parking Structures', 'Store Fronts/ Curtain Walls', 'Daylighting Solutions',
			'Ventilated Facades/Rainscreens', 'Guard Rails/Railings', 'Canopies', 'Doors/Entrances',
			'Windows/Skylights', 'Restoration', 'Stained Glass', 'Interior', 'Wall Cladding',
			'Lobbies & Elevator Cabs', 'Partitions', 'Shower Enclosures', 'Back-lit Walls',
			'Guard Rails/Railings', 'Backsplashes', 'Ceilings/Laylights', 'Lighting', 'Marker Boards', 
			'Stained Glass'
	];
...
function create_bulk_industry_posts() {
	...
	// Titles for the new posts
	$titles = [
			'Civic/Government/Cultural', 'Corporate/Financial', 'Education', 'Healthcare', 'Historical',
			'Hospitality', 'Life Sciences', 'Mixed Use', 'Parking', 'Religious',
			'Residential & Multi-Family', 'Retail', 'Sports/Recreation/Entertainment', 'Transportation & Aviation'
	];
